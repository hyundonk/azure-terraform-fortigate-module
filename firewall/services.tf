...
module "service1" {
  ...
  location                          = local.location_map["region1"]
  resource_group_name               = local.resource_group_hub_names["resourcegroup_name_auction_ext"]
  tags                              = local.tags
...
module "service2" {
  ...
  location                          = local.location_map["region1"]
  resource_group_name               = local.resource_group_hub_names["resourcegroup_name_auction_int"]
  tags                              = local.tags
